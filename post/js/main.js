...
const mainSlide = new Swiper(".slide_visual", {
    ...
    navigation: {
        nextEl: ".mian_visual .pager .right",
        prevEl: ".mian_visual .pager .left",
    },
});

const toggleBtn = document.querySelector('.mian_visual .btn_box i');
...
/* pager 숫자 업데이트 */
const numEl = document.querySelector('main .mian_visual .pager .box .num');
const totalEl = document.querySelector('main .mian_visual .pager .box .total')
...
//.selcet_box button을 클릭했을때
//.selcet_box on class가 토글

document.querySelector('footer .selcet_box button').addEventListener('click',function () {
  document.querySelector('footer .selcet_box').classList.toggle('on');
});
